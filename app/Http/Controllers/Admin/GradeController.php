...
{
    public function forStudentInSection(Section $section, Student $student)
    {
        $categoryOrder = ['long_quiz' => 0, 'tp' => 1, 'exam' => 2];

        // Lahat ng grade items na na-define sa section (mula sa kahit sinong estudyante)
        ...
        $merged = $items->map(function ($item) use ($studentGrades, $section, $student) {
